...
const char* ei_classifier_inferencing_categories[] = { "brother", "hello", "help", "i_love_you", "mom", "no", "please", "yes" };
...
const ei_impulse_t impulse_572912_0 = {
    .project_id = 572912,
    .project_owner = "Bryan Tang",
    .project_name = "bryanTang-project-1",
    .impulse_id = 1,
    .impulse_name = "Impulse #1",
    .deploy_version = 1,

    .nn_input_frame_size = 5625,
    .raw_sample_count = 5625,
    .raw_samples_per_frame = 1,
    .dsp_input_frame_size = 5625 * 1,
    .input_width = 75,
    .input_height = 75,
    .input_frames = 1,
    .interval_ms = 1,
    ...
    .visual_ad_grid_size_x = int((75 / 8) / 2 - 1),
    .visual_ad_grid_size_y = int((75 / 8) / 2 - 1),
...
ei_impulse_handle_t impulse_handle_572912_0 = ei_impulse_handle_t( &impulse_572912_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_572912_0;
