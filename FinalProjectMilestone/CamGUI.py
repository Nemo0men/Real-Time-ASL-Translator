...
EMBIGGEN_FACTOR = 10         # Scale image by this amount for viewport
...
class GUI:
    ...
    def __init__(self, root):
        ...
        # Create canvas
        self.canvas = tk.Canvas(self.frame_main, width=400, height=400)
    ...
    def refresh_image(self):
        ...
        if self.img_mutex.acquire(blocking=False):
            ...
            try:
                ...
                #self.tk.img = ImageTk.PhotoImage(self.img.resize((self.img.width * EMBIGGEN_FACTOR, self.img.height * EMBIGGEN_FACTOR), resample=Image.LANCZOS))
